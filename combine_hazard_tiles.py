# -*- coding: utf-8 -*-
"""
Created on Fri Jun 21 14:00:42 2024

@author: bern
trying the analysis from scratch

over here i am merging the 2 hazard tiles together for the same year (2020 and 2030) first. 
part 1 of analysis. 
"""
import os
import rasterio
...
# Function to generate input raster paths for the given folder path and return periods
